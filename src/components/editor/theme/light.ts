...
const chalky = "#e5c07b",
  ...
  highlightBackground = "rgba(0, 122, 204, 0.1)",
  background = "#ffffff",
...
export const totonooHighlightStyle = HighlightStyle.define([
  {tag: t.keyword,
   color: violet},
...
export const Light: Extension = [totonooTheme, totonooHighlightStyle]
